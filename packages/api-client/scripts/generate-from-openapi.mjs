...
const browserOperations = {
  ...
  adminRecruitmentInterviewSlots: { operation: "PUT /api/v1/admin/recruitment/batches/{batchId}/interview-slots", successStatus: "200" },
  memberNotifications: "GET /api/v1/notifications",
  memberNotificationUnreadCount: "GET /api/v1/notifications/unread-count",
  memberNotificationRead: { operation: "POST /api/v1/notifications/{notificationId}/read", successStatus: "200" },
  memberNotificationsReadAll: { operation: "POST /api/v1/notifications/read-all", successStatus: "200" },
