...
const browserOperations = {
  ...
  organizationPositionGrantProjectLead: "POST /api/v1/admin/organization/positions/project-leads/{personId}",
  organizationPositionRevokeProjectLead: { operation: "POST /api/v1/admin/organization/positions/project-leads/{personId}/revoke", successStatus: "200" },
