...
import { normalizeRedirectTarget } from "~/utils/login-continuation";
  ...
  <div class="login-page">
    <div class="login-page__context">
      <div>
        ...
        <h1>只在需要个人身份时登录</h1>
        <p>项目、活动、媒体作品和公开资源无需登录即可浏览。登录用于保护申请进度、考核结果、成长记录和个人资料。</p>
        <ul><li>查看申请与考核结果</li><li>提交或取消活动报名</li><li>编辑个人资料与头像</li><li>访问内部成员资料</li></ul>
      </div>
    </div>
    <div class="login-page__form">
      <div>
        ...
        <Form v-slot="{ errors, meta }" @submit="signIn">
          ...
          <button class="button" type="submit" :disabled="submitting || !meta.valid">{{ submitting ? "正在登录…" : "登录并继续" }}</button>
        </Form>
