...
<template>
  <div class="admin-recruitment-page admin-section-page">
    <AdminPageHeading eyebrow="结果发布" :title="`${batch?.name ?? '未知批次'} · 结果发布`">
      <template #actions>
