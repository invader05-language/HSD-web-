...
async function publish() {
  try {
    ...
    feedback.value = recruitmentGateway
      ? "发布完成：服务器已原子更新当前批次结果与成员投影。"
      : "Mock 发布完成：当前批次全部结果已同步到成员结果中心和正式成员投影。";
  } catch (reason) {
    showConfirmation.value = false;
